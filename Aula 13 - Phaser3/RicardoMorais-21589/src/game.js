...
game.state.add('play', {
    ...
    create: function() {
        ...
        upgradeButtonsData.forEach(function(buttonData, index) {
            ...
            button.costText = button.addChild(state.game.add.text(42, 24, 'Cost: ' + buttonData.cost, {
        ...
        this.levelKillsText = this.levelUI.addChild(this.game.add.text(0,
            30, 'Kills: ' + this.levelKills + '/' + this.levelKillsRequired, {
    ...
    onKilledMonster: function(monster) {
        ...
        this.currentMonster.maxHealth =
            Math.ceil(this.currentMonster.details.maxHealth + ((this.level - 1) * 10.6));
    ...
    onDPS: function() {
        ...
        if (this.player.dps > 0) {
            ...
            if (this.currentMonster && this.currentMonster.alive) {
                ...
                //Update the health text
                this.monsterHealthText.text =
                    this.currentMonster.alive ? Math.round(this.currentMonster.health) + ' HP' : 'DEAD';
